...
export const retailEcommerceTaskData: Record<string, TaskData> = {
  'retail-1': {
    ...
    code: task1Code,// ============================================
// ADDITIONAL RETAIL & E-COMMERCE DEMO TASKS
// Tasks 6–25
// ============================================

const additionalRetailTasks: Task[] = [
  {
    id: 'retail-6',
    title: 'LunaSkin Moisturizer Revenue by Channel',
    requestor: 'Emma Wright, Growth',
    status: 'sent',
    sentAt: minutesAgo(3),
    sentStatus: 'pending',
    timestamp: minutesAgo(10),
    priority: 'medium',
    description: 'How much revenue did LunaSkin Moisturizer generate by channel last month?',
    source: 'email',
    industry: 'retail-ecommerce',
    flags: { urgency: false, humanRequested: false, vip: false },
    confidence: 90
  ...
  {
    id: 'retail-7',
    title: 'NordicLamp Return Rate',
    requestor: 'Oliver Brown, Ops',
    status: 'sent',
    sentAt: minutesAgo(5),
    sentStatus: 'pending',
    timestamp: minutesAgo(15),
    priority: 'high',
    description: 'What is the return rate for NordicLamp over the last 90 days?',
    source: 'slack',
    industry: 'retail-ecommerce',
    flags: { urgency: true, humanRequested: false, vip: false },
    confidence: 87
  ...
  {
    id: 'retail-8',
    title: 'PureFit Yoga Mat Top Cities',
    requestor: 'Nina Patel, Marketing',
    status: 'sent',
    sentAt: minutesAgo(4),
    sentStatus: 'pending',
    timestamp: minutesAgo(18),
    priority: 'medium',
    description: 'Which cities sold the most PureFit Yoga Mats?',
    source: 'email',
    industry: 'retail-ecommerce',
    flags: { urgency: false, humanRequested: true, vip: false },
    confidence: 89
  ...
  {
    id: 'retail-9',
    title: 'AquaHome Filter Subscription Churn',
    requestor: 'Daniel Kim, Subscriptions',
    status: 'building',
    timestamp: minutesAgo(22),
    priority: 'high',
    description: 'What is the monthly churn rate for AquaHome Filter subscriptions?',
    source: 'dashboard',
    industry: 'retail-ecommerce',
  ...
  {
    id: 'retail-10',
    title: 'VoltEdge Power Bank Attach Rate',
    requestor: 'Sophia Lee, Product',
    status: 'sent',
    sentAt: minutesAgo(6),
    sentStatus: 'pending',
    timestamp: minutesAgo(25),
    priority: 'low',
    description: 'How often is VoltEdge Power Bank bought with a phone?',
    source: 'meeting',
    industry: 'retail-ecommerce',
    flags: { urgency: false, humanRequested: false, vip: false },
    confidence: 93
  ...
  {
    id: 'retail-11',
    title: 'FreshCart Grocery Average Order Value',
    requestor: 'Hassan Ali, Finance',
    status: 'sent',
    sentAt: minutesAgo(4),
    sentStatus: 'pending',
    timestamp: minutesAgo(30),
    priority: 'medium',
    description: 'What is the AOV for FreshCart grocery orders this quarter?',
    source: 'email',
    industry: 'retail-ecommerce',
    flags: { urgency: false, humanRequested: false, vip: false },
    confidence: 91
  ...
  {
    id: 'retail-12',
    title: 'UrbanStep Sneakers Size Distribution',
    requestor: 'Maria Gomez, Merchandising',
    status: 'sent',
    sentAt: minutesAgo(7),
    sentStatus: 'pending',
    timestamp: minutesAgo(35),
    priority: 'low',
    description: 'What shoe sizes sell most for UrbanStep Sneakers?',
    source: 'slack',
    industry: 'retail-ecommerce',
    flags: { urgency: false, humanRequested: false, vip: false },
    confidence: 88
  ...
  {
    id: 'retail-13',
    title: 'ZenSleep Pillow Repeat Purchase Rate',
    requestor: 'Tom Richards, CRM',
    status: 'building',
    timestamp: minutesAgo(38),
    priority: 'medium',
    description: 'How many customers repurchased ZenSleep Pillow?',
    source: 'email',
    industry: 'retail-ecommerce',
    flags: { urgency: false, humanRequested: true, vip: false },
    confidence: 86
  ...
  {
    id: 'retail-14',
    title: 'GreenChef Kit Delivery Delays',
    requestor: 'Ayesha Khan, Logistics',
    status: 'sent',
    sentAt: minutesAgo(5),
    sentStatus: 'pending',
    timestamp: minutesAgo(42),
    priority: 'high',
    description: 'Which regions experienced delivery delays last week?',
    source: 'slack',
    industry: 'retail-ecommerce',
    flags: { urgency: true, humanRequested: false, vip: false },
    confidence: 92
  ...
  {
    id: 'retail-15',
    title: 'PixelPro Camera Refund Reasons',
    requestor: 'Kevin Moore, CX',
    status: 'sent',
    sentAt: minutesAgo(6),
    sentStatus: 'pending',
    timestamp: minutesAgo(45),
    priority: 'medium',
    description: 'What are the top refund reasons for PixelPro Camera?',
    source: 'email',
    industry: 'retail-ecommerce',
    flags: { urgency: false, humanRequested: true, vip: false },
    confidence: 90
  ...
  {
    id: 'retail-16',
    title: 'ComfyHome Sofa Lead Time',
    requestor: 'William Scott, Supply Chain',
    status: 'sent',
    sentAt: minutesAgo(8),
    sentStatus: 'pending',
    timestamp: minutesAgo(48),
    priority: 'high',
    description: 'What is the average lead time for ComfyHome Sofa?',
    source: 'meeting',
    industry: 'retail-ecommerce',
    flags: { urgency: true, humanRequested: false, vip: false },
    confidence: 89
  ...
  {
    id: 'retail-17',
    title: 'KidsWorld Toy Seasonal Lift',
    requestor: 'Fatima Noor, Planning',
    status: 'sent',
    sentAt: minutesAgo(5),
    sentStatus: 'pending',
    timestamp: minutesAgo(52),
    priority: 'medium',
    description: 'Did KidsWorld toys see a holiday sales lift?',
    source: 'email',
    industry: 'retail-ecommerce',
    flags: { urgency: false, humanRequested: false, vip: false },
    confidence: 94
  ...
  {
    id: 'retail-18',
    title: 'AutoCare Oil Cross-Sell',
    requestor: 'Brian Adams, Sales',
    status: 'building',
    timestamp: minutesAgo(55),
    priority: 'medium',
    description: 'Which products are most often bought with AutoCare Oil?',
    source: 'dashboard',
    industry: 'retail-ecommerce',
    flags: { urgency: false, humanRequested: false, vip: true },
    confidence: 88
  ...
  {
    id: 'retail-19',
    title: 'PetPlus Subscription LTV',
    requestor: 'Zara Malik, Strategy',
    status: 'sent',
    sentAt: minutesAgo(6),
    sentStatus: 'pending',
    timestamp: minutesAgo(58),
    priority: 'high',
    description: 'What is the lifetime value of PetPlus subscribers?',
    source: 'email',
    industry: 'retail-ecommerce',
    flags: { urgency: true, humanRequested: false, vip: true },
    confidence: 91
  ...
  {
    id: 'retail-20',
    title: 'GlowFit Watch Cart Abandonment',
    requestor: 'Chris Evans, E-Commerce',
    status: 'sent',
    sentAt: minutesAgo(4),
    sentStatus: 'pending',
    timestamp: minutesAgo(60),
    priority: 'medium',
    description: 'How many users abandoned GlowFit Watch in cart?',
    source: 'slack',
    industry: 'retail-ecommerce',
    flags: { urgency: false, humanRequested: true, vip: false },
    confidence: 87
  ...
  {
    id: 'retail-21',
    title: 'OfficeEase Chair Bulk Orders',
    requestor: 'Linda Cho, B2B',
    status: 'sent',
    sentAt: minutesAgo(5),
    sentStatus: 'pending',
    timestamp: minutesAgo(65),
    priority: 'low',
    description: 'How many bulk orders were placed for OfficeEase Chair?',
    source: 'email',
    industry: 'retail-ecommerce',
    flags: { urgency: false, humanRequested: false, vip: false },
    confidence: 93
  ...
  {
    id: 'retail-22',
    title: 'TravelLite Backpack Margin',
    requestor: 'Omar Farooq, Finance',
    status: 'sent',
    sentAt: minutesAgo(7),
    sentStatus: 'pending',
    timestamp: minutesAgo(70),
    priority: 'medium',
    description: 'What is the gross margin for TravelLite Backpack?',
    source: 'dashboard',
    industry: 'retail-ecommerce',
    flags: { urgency: false, humanRequested: false, vip: false },
    confidence: 90
  ...
  {
    id: 'retail-23',
    title: 'SmartHome Bulb Firmware Failures',
    requestor: 'Irene Novak, QA',
    status: 'building',
    timestamp: minutesAgo(75),
    priority: 'high',
    description: 'How many SmartHome Bulbs failed firmware updates?',
    source: 'slack',
    industry: 'retail-ecommerce',
    flags: { urgency: true, humanRequested: false, vip: false },
    confidence: 85
  ...
  {
    id: 'retail-24',
    title: 'DailyMart Coupon Redemption',
    requestor: 'Paul Green, Promotions',
    status: 'sent',
    sentAt: minutesAgo(6),
    sentStatus: 'pending',
    timestamp: minutesAgo(80),
    priority: 'medium',
    description: 'What is the redemption rate of DailyMart coupons?',
    source: 'email',
    industry: 'retail-ecommerce',
    flags: { urgency: false, humanRequested: false, vip: false },
    confidence: 92
  ...
  {
    id: 'retail-25',
    title: 'UltraClean Vacuum Warranty Claims',
    requestor: 'Samantha Reed, Support',
    status: 'sent',
    sentAt: minutesAgo(8),
    sentStatus: 'pending',
    timestamp: minutesAgo(85),
    priority: 'high',
    description: 'How many warranty claims were filed for UltraClean Vacuum?',
    source: 'email',
    industry: 'retail-ecommerce',
